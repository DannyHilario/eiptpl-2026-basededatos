...
- [ ] El procedimiento se llama exactamente `usp_insertarMedico` y recibe los 6 parámetros de arriba (todos obligatorios, ninguno acepta `NULL`).
...
- [ ] Valida que `@p_Telefono` no esté ya registrado por otro médico; si ya existe, regresa `ErrCodigo = '000002'`, `ErrMensaje = 'El teléfono ya está registrado'`, y termina con `RETURN`.
- [ ] Valida que `@p_Correo` no esté ya registrado por otro médico; si ya existe, regresa `ErrCodigo = '000003'`, `ErrMensaje = 'El correo ya está registrado'`, y termina con `RETURN`.
...
EXEC usp_insertarMedico @p_Nombre = 'Prueba', @p_PrimerApellido = 'Prueba', @p_SegundoApellido = 'Prueba',
     @p_Cedula = '10234501', @p_Telefono = '8112009999', @p_Correo = 'prueba@hospitaldb.com'

-- Teléfono duplicado (el del médico 2)
EXEC usp_insertarMedico @p_Nombre = 'Prueba', @p_PrimerApellido = 'Prueba', @p_SegundoApellido = 'Prueba',
     @p_Cedula = '10234512', @p_Telefono = '8112000002', @p_Correo = 'prueba2@hospitaldb.com'
```
