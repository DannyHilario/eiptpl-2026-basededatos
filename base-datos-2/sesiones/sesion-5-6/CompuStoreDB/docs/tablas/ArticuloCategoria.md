...
No tiene `Activo`: no es un catálogo, y no necesita baja lógica — quitar una asignación es un `DELETE` físico (ver [`usp_quitarCategoriaArticulo`](../procedimientos/usp_quitarCategoriaArticulo.md)).
...
[`usp_asignarCategoriaArticulo`](../procedimientos/usp_asignarCategoriaArticulo.md) · [`usp_quitarCategoriaArticulo`](../procedimientos/usp_quitarCategoriaArticulo.md)
