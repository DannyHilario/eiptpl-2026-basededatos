...
| `Cerrado` | `BIT` | No | `0` | `1` = ya fue entregado (ver [`usp_entregarPedido`](../procedimientos/usp_entregarPedido.md)); congela el pedido y sus líneas contra más cambios |
...
[`usp_insertarPedido`](../procedimientos/usp_insertarPedido.md) · [`usp_eliminarPedido`](../procedimientos/usp_eliminarPedido.md) · [`usp_actualizarPedido`](../procedimientos/usp_actualizarPedido.md) · [`usp_entregarPedido`](../procedimientos/usp_entregarPedido.md) · [`ufn_calcularTotalPedido`](../funciones/ufn_calcularTotalPedido.md) · [`vw_PedidoResumen`](../vistas/vw_PedidoResumen.md)
