...
[`usp_insertarHistoricoPrecioArticulo`](../procedimientos/usp_insertarHistoricoPrecioArticulo.md) (pieza interna) · [`usp_actualizarPrecioArticulo`](../procedimientos/usp_actualizarPrecioArticulo.md) (el que se debe usar para cambiar un precio)
