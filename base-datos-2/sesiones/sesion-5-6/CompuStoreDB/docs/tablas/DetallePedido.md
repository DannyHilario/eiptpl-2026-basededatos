...
| `PrecioUnitario` | `DECIMAL(10,2)` | No | — | Precio **congelado** al momento de agregar la línea — no es el precio de lista vigente de `Articulo`, es el que se pactó en esa venta (ver [`usp_insertarDetallePedido`](../procedimientos/usp_insertarDetallePedido.md)) |
...
[`usp_insertarDetallePedido`](../procedimientos/usp_insertarDetallePedido.md) · [`usp_eliminarDetallePedido`](../procedimientos/usp_eliminarDetallePedido.md) · [`usp_actualizarDetallePedido`](../procedimientos/usp_actualizarDetallePedido.md)
