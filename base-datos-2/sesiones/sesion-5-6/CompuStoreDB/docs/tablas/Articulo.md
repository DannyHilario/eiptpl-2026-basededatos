...
| `PrecioUnitario` | `DECIMAL(10,2)` | No | — | Precio de lista **vigente**. Cambia solo vía [`usp_actualizarPrecioArticulo`](../procedimientos/usp_actualizarPrecioArticulo.md) |
...
[`usp_insertarArticulo`](../procedimientos/usp_insertarArticulo.md) · [`usp_eliminarArticulo`](../procedimientos/usp_eliminarArticulo.md) · [`usp_habilitarArticulo`](../procedimientos/usp_habilitarArticulo.md) · [`usp_actualizarArticulo`](../procedimientos/usp_actualizarArticulo.md) · [`usp_actualizarPrecioArticulo`](../procedimientos/usp_actualizarPrecioArticulo.md)
